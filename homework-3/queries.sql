...
-- 1. Название компании заказчика ( из табл. customers) и ФИО сотрудника, работающего над заказом этой компании (см таблицу employees),
...
SELECT product_name
FROM products
WHERE EXISTS (SELECT * FROM order_details WHERE quantity = 10 
